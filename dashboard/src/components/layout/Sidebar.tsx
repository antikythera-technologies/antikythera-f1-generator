  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-64 flex-col border-r border-white/10 bg-midnight/90 backdrop-blur-xl">
      ...
      <div className="flex h-16 items-center gap-3 border-b border-white/10 px-6">
        ...
        <div>
          <h1 className="font-bold text-white">Antikythera</h1>
          <p className="text-xs text-neon-cyan">F1 Video Generator</p>
        </div>
      </div>
        ...
        {navigation.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.name}
              {isActive && (
                <div className="ml-auto h-1.5 w-1.5 rounded-full bg-neon-cyan" />
              )}
            </Link>
          );
        })}
      ...
      <div className="border-t border-white/10 p-4">
        <div className="rounded-lg bg-twilight/50 p-3">
          ...
          <p className="mt-1 text-xs text-white/40">v0.1.0 - Alpha</p>
        </div>
      </div>
    </aside>
  );
